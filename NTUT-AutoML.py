...
st.write('Automatic Machine Learning designed by NTUT Industry 4.0 Consulting Group (v1.3)')
...
classifier_name = st.sidebar.selectbox(
    '2. Select classifier',
    ('KNN', 'SVM', 'Random Forest', 'autoML', 'autoML: Regression', 'LSTM-Time Series')
)
...
if submit2 and classifier_name != 'LSTM-Time Series' and classifier_name != 'autoML: Regression': #Predict buttom
    data2 = pd.read_csv(uploaded_file) #Training data
    data = pd.read_csv(uploaded_file2) #Predict data
    y = data2.values[:,0]    
...
if submit and classifier_name != 'LSTM-Time Series' and classifier_name != 'autoML: Regression': #Train Buttom
    data3 = get_dataset(uploaded_file)        
    data  = data3.copy()
    data2 = data3.copy()
